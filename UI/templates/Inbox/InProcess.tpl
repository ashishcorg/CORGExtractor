<span class="label label-warning crisp-span">In Process</span>
...
<div class="panel panel-default crisp-panel crisp-panel-margin">
    ...
    <div class="panel-collapse collapse">
	  ...
	  <div>
		...
		<a class="reply" style="cursor:pointer;" href="<%=ticket.get("_id") %>"><span class= "fa fa-reply pull-right fa-2x" data-toggle="tooltip" data-placement="bottom" data-original-title="Send a Reply to customer."></span></a>
		</div>
	  </div>
