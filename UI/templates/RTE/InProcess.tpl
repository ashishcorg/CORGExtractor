        ...
        <div id="formatting-container" style="border-bottom: 1px solid #ccc;border-top: 1px solid #ccc;background-color:#f5f5f5; padding:5px 10px">
         <select title="Font" class="ql-font" style="vertical-align:bottom;">
		  ...
		  <div class="btn-group pull-right" style="margin-left: 10px;">
			  <a href="<%=id%>" class="btn btn-primary sendreply"><span class="fa fa-reply"></span> Reply</a>
			  <a href="#" class="btn btn-primary dropdown-toggle" data-toggle="dropdown" aria-expanded="false"><span class="caret"></span></a>
			  <ul class="dropdown-menu">
				<li><a class="sendreplyclose" href="<%=id%>"><span class="fa fa-users"></span>Reply and close</a></li>
				<li class="divider"></li>
				<li><a class="sendinfo "  href="<%=id%>"><span class="fa fa-users"></span>Info to customer</a></li>
				<li class="divider"></li>
				<li><a class="sendCall" href="<%=id%>"><span class="fa fa-users"></span>Call to customer</a></li>
				<li class="divider"></li>
				<li><a class="sendmemo" href="<%=id%>"><span class="fa fa-users"></span>Internl memo</a></li>
				
				
			  </ul>
			</div>
          <button class="btn btn-warning pull-right cancelirt" style="margin-left: 10px;" >
